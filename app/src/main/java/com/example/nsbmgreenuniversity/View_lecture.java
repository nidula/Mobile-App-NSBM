...
public class View_lecture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventlist = (ListView) findViewById(R.id.view3);

        list = new ArrayList<>();


        DatabaseReference databaseReference = firebaseDatabase.getReference().child("Lectures");
